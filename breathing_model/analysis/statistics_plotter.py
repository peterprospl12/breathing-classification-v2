...
cm_tomasz = np.array([
    [45, 2, 1],    # Inhale: correctly as inhale, incorrectly as exhale, incorrectly as silence
    [0, 47, 0],    # Exhale: incorrectly as inhale, correctly as exhale, incorrectly as silence
    [0, 1, 23]     # Silence: incorrectly as inhale, incorrectly as exhale, correctly as silence
])
...
matrices = [
        (cm_tomasz, "All data Tomasz"),
        (cm_piotr, "All data Piotr"),
        (cm_iwo, "All data Iwo"),
        (cm_good, "All good microphones"),
        (cm_medium, "All medium microphones"),
        (cm_bad, "All poor microphones"),
        (cm_all, "All data")
    ]
