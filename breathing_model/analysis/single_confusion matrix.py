...
cm_good = np.array([
    [11, 0, 0], # Inhale: correctly as inhale, incorrectly as exhale, incorrectly as silence
    [0, 10, 0], # Exhale: incorrectly as inhale, correctly as exhale, incorrectly as silence
    [0, 1, 4]  # Silence: incorrectly as inhale, incorrectly as exhale, correctly as silence
])

matrices = [
        (cm_good, "Macierz pomyłek dla przykładowego nagrania (transformer)")
    ]
