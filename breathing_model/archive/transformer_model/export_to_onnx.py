...
def export_breath_classifier_to_onnx(model_path, onnx_path, audio_length=13230):
    ...
    classifier = BreathPhaseTransformerSeq(n_mels=128, num_classes=3, d_model=192, nhead=8, num_transformer_layers=6)
...
if __name__ == "__main__":
    ...
    breath_model_path = "../../model/trained_models/1/transformer_model_88.pth"
    breath_onnx_path = "../../model/trained_models/1/transformer_model_88.onnx"

    # # Anomaly detector paths
    # anomaly_model_path = "../invalid_data_filter/best_breathing_anomaly_detector.pth"
    # anomaly_threshold_path = "../invalid_data_filter/anomaly_threshold.json"
